...
fstream RowFile("D:/大二下/paralleling/实验/lab2/Groebner/测试样例7 矩阵列数8399，非零消元子6375，被消元行4535/被消元行.txt", ios::in | ios::out);
fstream BasisFile("D:/大二下/paralleling/实验/lab2/Groebner/测试样例7 矩阵列数8399，非零消元子6375，被消元行4535/消元子.txt", ios::in | ios::out);
...
void reset() {
	...
	RowFile.close();
	BasisFile.close();
	RowFile.open("D:/大二下/paralleling/实验/lab2/Groebner/测试样例7 矩阵列数8399，非零消元子6375，被消元行4535/被消元行.txt", ios::in | ios::out);
	BasisFile.open("D:/大二下/paralleling/实验/lab2/Groebner/测试样例7 矩阵列数8399，非零消元子6375，被消元行4535/消元子.txt", ios::in | ios::out);
	iToBasis.clear();
	iToFirst.clear();
	ans.clear();
...
int main() {
	...
	for (int i = 0; i < 1; i++) {
		ofstream out("D:大二下/paralleling/实验/lab2/Groebner/测试样例7 矩阵列数8399，非零消元子6375，被消元行4535/消元结果.txt");
		ofstream out1("D:/大二下/paralleling/实验/lab2/Groebner/测试样例7 矩阵列数8399，非零消元子6375，被消元行4535/消元结果(AVX).txt");
		out << "__________" << endl;
