...
//           // cout << "线程数: " << i << endl;
            ...
            //for(int w=0;w<10;w++)
                m_gauss_h(n, i);
            QueryPerformanceCounter((LARGE_INTEGER *)&tail );
            cout << "静态线程、水平划分、信号量同步版本时间：" << ( tail - head) * 1000.0 / (freq) << "ms" << endl;
//             m_reset(n);
//            QueryPerformanceCounter((LARGE_INTEGER *)&head);
//           // for(int w=0;w<5;w++)
//                m_gauss_h2(n, i);
//            QueryPerformanceCounter((LARGE_INTEGER *)&tail );
//            cout << "静态线程、水平划分、barrier同步版本时间：" << ( tail - head) * 1000.0 /(freq) << "ms" << endl;
//
////            m_reset(n);
////            QueryPerformanceCounter((LARGE_INTEGER *)&head);
////            m_gauss_v2(n, i);
////            QueryPerformanceCounter((LARGE_INTEGER *)&tail );
////            cout << "静态线程、垂直划分、信号量同步版本时间：" << ( tail - head) * 1000.0 / freq << "ms" << endl;
//
//            m_reset(n);
//            QueryPerformanceCounter((LARGE_INTEGER *)&head);
//            //for(int w=0;w<5;w++)
//                m_gauss_v(n, i);
//            QueryPerformanceCounter((LARGE_INTEGER *)&tail );
//            cout << "静态线程、垂直划分、barrier同步版本时间：" << ( tail - head) * 1000.0 /(freq )<< "ms" << endl;
...
//静态线程+barrier同步，全部工作线程，水平划分版本线程函数定义
...
//静态线程+barrier同步，全部工作线程，垂直划分版本线程函数定义
